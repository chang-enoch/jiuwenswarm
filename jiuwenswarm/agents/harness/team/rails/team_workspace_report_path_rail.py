...
class TeamWorkspaceReportPathRail(DeepAgentRail):
    ...
    async def before_model_call(self, ctx: AgentCallbackContext) -> None:
        ...
        content = (
            ...
            "- The team shared workspace is for member-to-member handoff artifacts only; "
            "user-facing deliverables live in the task working directory and must be sent "
            "via `send_file_to_user` from there.\n"
