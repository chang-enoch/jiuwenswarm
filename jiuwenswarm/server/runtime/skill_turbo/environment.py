...
class SkillTurboEnvironment:
    ...
    def __init__(self, config: dict[str, Any]):
        ...
        self._skill_code_validator = PlanCodeValidator.for_skill_code(
    ...
    def _scan_skills_dir(self) -> None:
        ...
        for skill_dir in base.iterdir():
            ...
            try:
                ...
                meta = load_skill_meta(skill_name, skill_dir)
                skill = Skill(
                    name=skill_name,
    ...
    def _scan_external_turbo_skills(self) -> None:
        ...
        if not discovered:
            logger.warning(
                "[SkillTurboEnvironment] external turbo scan: skill dirs configured "
                "but no turbo skills discovered; acceleration will degrade to "
                "standard flow. roots=%s",
        ...
        for item in discovered:
            ...
            if not package_name:
                logger.warning(
                    "[SkillTurboEnvironment] external turbo skill=%s rejected: "
    ...
    def _validator_for_external_skill(self, skill_name: str) -> PlanCodeValidator:
        ...
        return PlanCodeValidator.for_skill_code(
