# -*- coding: utf-8 -*-
"""load_skill_meta 接受条件与回退语义（含仅 external_name 的最小 meta.json）。"""
...
from jiuwenswarm.server.runtime.skill_turbo.skill_meta import load_skill_meta
...
def test_meta_with_only_external_name_is_accepted(tmp_path: Path) -> None:
    ...
    meta = load_skill_meta("demo_skill", skill_dir)
...
def test_meta_without_known_keys_returns_empty(tmp_path: Path) -> None:
    ...
    assert load_skill_meta("demo_skill", skill_dir) == {}
